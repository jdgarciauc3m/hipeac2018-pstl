\begin{frame}[t]{Which algorithms are included?}
\begin{itemize}
...
\begin{itemize}
  ...
  \item \textmark{Element reordering}:
    ...
    \cppid{rotate},
    \cppid{rotate\_copy}.
  \item \textmark{Swapping}: \cppid{swap\_ranges}.
  \item \textmark{Element transformation}: \cppid{transform}.
\end{itemize}
\end{frame}

\begin{frame}[t]{Partitioning, sorting and set}
\begin{itemize}
